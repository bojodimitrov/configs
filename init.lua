...
require('telescope').setup {
  defaults = {
    file_ignore_patterns = { "node%_modules/.*", ".git", ".vs" },
    mappings = {
      i = {
        ['<C-u>'] = false,
        ['<C-d>'] = false,
...
vim.keymap.set('n', '<Leader>tf', pass_args(require('nvim-tree.api').tree.find_file, { update_root = true, open = true, focus = true, }), { desc = 'Open nvim-[T]ree [F]ind file' })
...
--   require('telescope.builtin').git_files().grep_string({ search = vim.fn.input("Grep > ") });
-- end)
